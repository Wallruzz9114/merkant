  ...
  if (isDarkModeEnable) {
    ...
    return ThemeData(
      ...
      textButtonTheme: TextButtonThemeData(
          style: ButtonStyle(
        padding:
            WidgetStateProperty.all(const EdgeInsets.only(top: 10, bottom: 10)),
      ...
      dividerTheme: DividerThemeData(
          color: const Color(0xFFEDF2F6).withOpacity(0.5), thickness: 1.5),
      radioTheme: RadioThemeData(
        fillColor: WidgetStateProperty.all(const Color(0xFFF4694A)),
      ),
      cardTheme: CardTheme(
        elevation: 0.5,
    ...
    return ThemeData(
      ...
      bottomSheetTheme:
          const BottomSheetThemeData(backgroundColor: Color(0xFF5c7de0)),
      cardTheme: CardTheme(
        elevation: 0.5,
        margin: EdgeInsets.zero,
